    ...
    <div className="LoginCard">
      ...
      <div className="login-form">
        ...
        {emptyEmail && (
          <div className="form-msg">
            <p
              ...
              style={{ textAlign: "center", fontSize: "14px", padding: "0" }}
            >
        ...
        {emailEnteredIsTrue && weAreInForgetPassPage && (
          <div className="form-msg">
            <p data-testid="invalid-email" style={{ textAlign: "center" }}>
        ...
        {weAreInForgetPassPage && (
          <div
            onClick={test && recaptchaCallback}
        ...
        {!weAreInForgetPassPage && (
          <div data-testid="confirmation-msg" className="show-msg">
            <div className="form-msg">
              ...
              <p>
                Please make sure it didn't wind up in your Junk Mail. If you
                aren't receiving our password reset emails, see our
