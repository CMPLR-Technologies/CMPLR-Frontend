...
describe("Home Section 1", () => {
  it("should render without crashes", () => {
    render(<MockedComponent component={<HomeSec1 />} />);
  ...
  it("should render the heading as passed in props", () => {
    render(
      <MockedComponent component={<HomeSec1 last={false} heading="head1" />} />
    );
  ...
  it("should render the description paragraph as passed in props", () => {
    render(
      <MockedComponent
        component={<HomeSec1 last={false} paragraph="para1" />}
      />
    );
  ...
  it("should render login button with right name and className", () => {
    render(<MockedComponent component={<HomeSec1 last={false} />} />);
  ...
  it("should display author of background image", () => {
    ...
    expect(bgAuthor.firstChild.textContent).toBe(backgroundImages[0].author);
  });
});
...
describe("Home Section 6", () => {
  it("should render without crashes", () => {
    render(<MockedComponent component={<HomeSec1 last={true} />} />);
