 ...
 * @description [Static page ]Section Five Component of HomePage
 * @returns {Component} the Component of the Section Five
 */
                ...
                <div className="fifth-page-container">
                    <div className="fifth-page-content">
                        <div className="fifth-page-posts-type">
                            ...
                            />
                            <PostType
                                dataTestid="svg-photo"
                                SVG={<Photo />}
                                type="photo"
                            />
                            <PostType
                                dataTestid="svg-qoute"
                                SVG={<Quote />}
                                type="Quote"
                            />
                            <PostType
                            ...
                            />
                            <PostType
                                dataTestid="svg-video"
                                SVG={<Video />}
                                type="Video"
                            />
                        </div>
                        <h1
                            data-testid="sec5-heading"
                            className="sec-page-heading"
                        >
                            Seriously, put anything you want here.
                        </h1>
                        <p
                            data-testid="sec5-paragraph"
                            className="sec-page-para"
                        >
                            Seven post types to get you started. Your brain can
                            do the rest. This thing is yours. Use it however you
                            like.
                        </p>
                    </div>
                </div>
