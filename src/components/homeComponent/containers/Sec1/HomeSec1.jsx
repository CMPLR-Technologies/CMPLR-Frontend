    ...
    <>
      ...
      >
        <div data-testid="sec1-content" className="first-page-content">
          <div data-testid="sec1-logo-container" className="logo-container">
            {!last ? (
              <>
              ...
              <>
                <h1 data-testid="sec1-heading" className="sixth-page-heading">
                  {heading}
                </h1>
                <p
          ...
          <p className="first-page-terms">
            ...
            <Link to="/terms">Terms of Service</Link> and have read the{" "}
