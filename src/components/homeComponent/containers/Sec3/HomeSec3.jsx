      ...
      >
        <div className="third-page-content">
          <div className="third-page-info">
            <h1 data-testid="sec3-heading" className="sec-page-heading">
              Cmplr is blogs
            </h1>
            <p data-testid="sec3-paragraph" className="sec-page-para">
              ...
              follow blogs like that, and we’ll help other people find and
              follow yours.
            </p>
          </div>
        </div>
